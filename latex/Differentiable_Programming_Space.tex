...
The \emph{double id} stands for the identity operator $1$ in expression \eqref{eq:rekurzija}, while the \emph{map<var*, var> dTau} stands for the operator $\D\sumd_k$.
