...
\end{lstlisting}
Note that while the class \emph{tau} represents the operator \eqref{eq:sumd}, its instances represent the image of \eqref{eq:sumd}, via its (\emph{tau}) evaluation operator \emph{()}.
